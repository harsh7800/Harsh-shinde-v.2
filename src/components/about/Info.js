      ...
      <div className="about-info" data-aos="fade-right">
        <p>
          * I completed my engineering in Electrical so yeah,you can say that i
          ...
          get your work done. during this quarantine i found myself intrested in
          programming so, I started digging more about it, then i came across
          web-devlopement now, i started learning further to be a{" "}
          <a
        ...
        <p>
          * I am currently doing a internship at ------------- company,I know I
          will gain much experience from working in the real world projects. And
          i aim to contribute as much i can with all the knowledge i have and
